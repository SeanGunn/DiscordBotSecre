...
(function() {
    ...
    async function getMondayShed() {
        let answer1 = await getRequest(3000);
        return answer1;
    }
...
/*module.exports = new Promise(function(resolve,reject){
    ...
    module.exports = new Promise(function(resolve, reject){
        async.function(function(response) {
           let foo = request('https://api.jikan.moe/v3/schedule/monday', function (error, response, body) {
                var t = JSON.parse(body);
                var sizeTues = Object.keys(t.monday).length;
                var i = 0;
                var string = "__**The shows that are on Monday are: **__\n";
            ...
            if(foo === "undefined"){
                reject("Their was a problem getting the shedule for monday.");
            }else{
                resolve(foo);
            }
...
function getMondayShedPromise() {
    let mondayShed = function(resolve,reject){
        request('https://api.jikan.moe/v3/schedule/monday', function (error, response, body) {
                var t = JSON.parse(body);
                var sizeTues = Object.keys(t.monday).length;
                var i = 0;
